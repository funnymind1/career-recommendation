    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6 flex items-center gap-4" x-data="{ show: false }"
                ...
                <h1 class="text-2xl font-bold text-gray-900">Post New Internship</h1>
            </div>
                ...
                <form action="{{ route('admin.internships.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="location" value="{{ old('location') }}"
                                placeholder="e.g. Remote, Lagos" required
                                class="w-full rounded-xl border-gray-200 focus:border-brand-500 focus:ring-brand-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="duration" value="{{ old('duration') }}" placeholder="e.g. 3 Months"
                                required
                                class="w-full rounded-xl border-gray-200 focus:border-brand-500 focus:ring-brand-500">
                    ...
                    <div>
                        ...
                        <textarea name="details" rows="5" required
                            class="w-full rounded-xl border-gray-200 focus:border-brand-500 focus:ring-brand-500">{{ old('details') }}</textarea>
                    ...
                    <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                        ...
                        <button type="submit"
                            class="px-5 py-2.5 bg-brand-600 text-white font-medium rounded-xl shadow-sm hover:bg-brand-700 transition">Post
                            Internship</button>
                    </div>
                </form>
            </div>
