    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6 flex items-center gap-4" x-data="{ show: false }"
                ...
                <h1 class="text-2xl font-bold text-gray-900">Create New Career Path</h1>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm" x-data="{ show: false }"
                ...
                <form action="{{ route('admin.career-paths.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" placeholder="e.g. Product Manager"
                            required
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3" required
                            class="w-full rounded-xl border-gray-200 focus:border-brand-500 focus:ring-brand-500">{{ old('description') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="tags" value="{{ old('tags') }}"
                                placeholder="e.g. Leadership, Agile, Strategy" required
                                class="w-full rounded-xl border-gray-200 focus:border-brand-500 focus:ring-brand-500">
                            <p class="text-xs text-gray-400 mt-1">These labels are shown visually on the career card.
                            </p>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Quiz Match Keywords (Comma
                                separated)</label>
                            <input type="text" name="match_keywords" value="{{ old('match_keywords') }}"
                                placeholder="e.g. leadership, communication, strategy" required
                                class="w-full rounded-xl border-gray-200 focus:border-brand-500 focus:ring-brand-500">
                            <p class="text-xs text-gray-400 mt-1">Used by the quiz algorithm to match students to this
                                path (lowercase).</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 border-t border-gray-100">
                        <div>
                            ...
                            <input type="text" name="average_salary" value="{{ old('average_salary') }}"
                                placeholder="e.g. $80k - $120k" required
                                class="w-full rounded-xl border-gray-200 focus:border-brand-500 focus:ring-brand-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="required_education" value="{{ old('required_education') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="projected_growth" value="{{ old('projected_growth') }}"
                                placeholder="e.g. High (20% by 2030)" required
                                class="w-full rounded-xl border-gray-200 focus:border-brand-500 focus:ring-brand-500">
                    ...
                    <div class="flex justify-end gap-3 pt-6 border-t border-gray-100 mt-8">
                        ...
                        <button type="submit"
                            class="px-5 py-2.5 bg-brand-600 text-white font-medium rounded-xl shadow-sm hover:bg-brand-700 transition">Create
                            Path</button>
                    </div>
                </form>
            </div>
